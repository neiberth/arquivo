            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="setor" class="col-md-4 col-form-label text-md-end">Setor</label>

                            <div class="col-md-6">
                                <input id="setor" type="text" class="form-control @error('setor') is-invalid @enderror text-uppercase" name="setor" value="{{ old('setor') }}" required autocomplete="setor" autofocus>
